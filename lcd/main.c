...
int main()
{
    ...
    while (1)
    {
        ...
        rect(pixels, w, h, pos_x, pos_y, 20, 20, RGBtoHEX(0, 150, 0));

        string(pixels, w, h, "MOUNTAIN", 9, 50, 50, getStringWidth(9, 50), 50, RGBtoHEX(0, 150, 0), 2);
        string(pixels, w, h, "DEW", 9, 60, 50, getStringWidth(9, 80), 80, RGBtoHEX(255, 0, 0), 2);
